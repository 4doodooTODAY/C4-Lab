      ...
      <div className="space-y-5">
        ...
        <div className="card p-6">
          ...
          <div className="mb-4">
            ...
            <input
              className="input w-full bg-surface-2 text-text-muted cursor-not-allowed"
              value={user?.email || ''}
              disabled
            />
          </div>
          ...
          <div className="mb-4">
            ...
            <input
              className="input w-full bg-surface-2 text-text-muted cursor-not-allowed capitalize"
          ...
          <form onSubmit={handleNameSave}>
            ...
            <div className="flex gap-2">
              ...
              <button
                type="submit"
                disabled={nameSaving || name.trim() === profile?.full_name}
